      ...
      e: for (var H = 0, G = x.length, bt = G >>> 1; H < bt; ) {
        ...
        if (0 > l(gl, L))
          yn < G && 0 > l(er, gl)
            ? ((x[H] = er), (x[yn] = L), (H = yn))
            : ((x[H] = gl), (x[vn] = L), (H = vn));
        else if (yn < G && 0 > l(er, L)) (x[H] = er), (x[yn] = L), (H = yn);
        else break e;
      }
    }
    return z;
...
function ia(e) {
  ...
  function w(f, a, d, v) {
    for (
      var E = null, C = null, _ = a, N = (a = 0), Q = null;
      _ !== null && N < d.length;
      N++
    ) {
  ...
  function S(f, a, d, v) {
    ...
    for (
      var C = (E = null), _ = a, N = (a = 0), Q = null, R = d.next();
      _ !== null && !R.done;
      N++, R = d.next()
    ) {
      _.index > N ? ((Q = _), (_ = null)) : (Q = _.sibling);
...
function pi(e, n) {
  switch ((M(Qt, n), M(Bt, e), M(Ue, qt), (e = n.nodeType), e)) {
    case 9:
    case 11:
  ...
  switch ((ii(n), n.tag)) {
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (((t = En(Qt.current)), En(Ue.current), dr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Fe] = n),
...
function je(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(j & 2) || e !== J) &&
      ...
      pe(e, r),
      t === 1 && j === 0 && !(n.mode & 1) && ((lt = W() + 500), il && hn()));
}
function pe(e, n) {
  ...
  if (n !== 0) {
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = Ci + 500 - W()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
...
function Sd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > W() - Ci)
        ? xn(e, 0)
        : (xi |= t)),
    pe(e, n);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, W()), !(j & 6) && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = _i;
gs = Ln;
var Ld = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, vs, _i] },
  yt = {
...
function Od() {
  return P.jsxs("header", {
    ...
    children: [
      P.jsx("img", { src: jd, alt: "React logo" }),
      P.jsx("h1", { children: "The React Quiz" }),
    ],
  });
}
function Md({ children: e }) {
  return P.jsx("main", { className: "main", children: e });
}
function Dd() {
  return P.jsxs("div", {
...
function Fd({ numQuestions: e = 0, handleClick: n }) {
  return P.jsxs("div", {
    className: "start",
    children: [
      P.jsx("h2", { children: "Welcome to the React QUizz!" }),
      P.jsxs("h3", { children: [e, " questions to test your React mastery."] }),
      P.jsx("button", {
        className: "btn",
        onClick: () => n({ type: "start" }),
        children: "Lets Start",
      }),
    ],
  });
}
function Id({ question: e, dispatch: n, answer: t }) {
  const r = t !== null;
  return P.jsx("div", {
    className: "options",
    children:
      e == null
        ...
        : e.options.map((l, o) =>
            P.jsx(
              "button",
              {
                className: `btn btn-option ${o === t ? "answer" : ""} ${
                  r ? (o === e.correctOption ? "correct" : "wrong") : ""
                } `,
                disabled: t !== null,
                onClick: () => n({ type: "newAnswer", payLoad: o }),
                children: l,
              },
              l
            )
...
function Ud({ question: e, dispatch: n, answer: t }) {
  return P.jsxs("div", {
    children: [
      P.jsx("h4", { children: e == null ? void 0 : e.question }),
      P.jsx(Id, { question: e, dispatch: n, answer: t }),
    ],
  });
}
function $d({ dispatch: e, answer: n, index: t, numQuestions: r }) {
  if (n === null) return null;
  if (t < r - 1)
    return P.jsx("button", {
      className: "btn btn-ui",
      onClick: () => e({ type: "nextQueston" }),
      children: "Next",
    });
  if (t === r - 1)
    return P.jsx("button", {
      className: "btn btn-ui",
      onClick: () => e({ type: "finished" }),
      children: "Finished",
    });
}
function Ad({
  ...
  return P.jsxs("header", {
    className: "progress",
    children: [
      P.jsx("progress", { max: n, value: e + +(l !== null) }),
      P.jsxs("p", {
        children: ["Question ", P.jsx("strong", { children: e + 1 }), "/", n],
      }),
      P.jsxs("p", { children: [P.jsx("strong", { children: t }), "/", r] }),
    ],
  });
}
function Vd({ points: e, maxPossiblePoints: n, highscore: t, dispatch: r }) {
  const l = (e / n) * 100;
  let o;
  return (
    l === 100
    ...
    P.jsxs(P.Fragment, {
      children: [
        P.jsxs("p", {
          className: "result",
          children: [
            P.jsx("span", { className: "emoji", children: o }),
            "You scored ",
            P.jsx("strong", { children: e }),
            " out of",
            " ",
            P.jsxs("strong", { children: [n, "(", Math.ceil(l), "%)"] }),
            " ",
            "points!",
          ],
        }),
        P.jsxs("p", {
          className: "highscore",
          children: ["Highscore: ", t, " points"],
        }),
        P.jsx("button", {
          className: "btn btn-ui",
          onClick: () => r({ type: "restart" }),
...
function Bd({ children: e }) {
  return P.jsx("footer", { children: e });
}
function Qd({ secondsRemaining: e, dispatch: n }) {
...
function Kd(e, n) {
  switch (n.type) {
    case "dataRecieved":
      return { ...e, questions: n.payLoad, status: "ready" };
    case "dataFailed":
    ...
    case "start":
      return {
        ...e,
        status: "active",
        secondsRemaining: e.questions.length * Hd,
      };
    case "newAnswer":
      const t = e.questions.at(e.index),
        r = t.correctOption === n.payLoad;
      return {
        ...e,
        answer: n.payLoad,
        points: r ? e.points + t.points : e.points,
      };
    case "nextQueston":
      return { ...e, index: e.index + 1, answer: null };
    case "finished":
      return {
        ...e,
        status: "finished",
        highscore: e.points > e.highscore ? e.points : e.highscore,
      };
    case "restart":
      return {
        ...e,
        ...
        answer: null,
        points: 0,
        secondsRemaining: 1e3,
      };
    case "tick":
      return {
        ...e,
        secondsRemaining: e.secondsRemaining - 1,
        status: e.secondsRemaining === 0 ? "finished" : e.status,
      };
    default:
      throw new tc();
  }
...
function Yd() {
  const [
    ...
    s = e.length,
    c = e.reduce((m, p) => m + p.points, 0),
    h = "https://api.jsonbin.io/v3/b/65386e5f12a5d37659902210";
  return (
    Jn.useEffect(function () {
      fetch(h)
        .then(function (m) {
          return m.json();
        })
        .then(function (m) {
          console.log(m),
            u({ type: "dataRecieved", payLoad: m.record.questions });
        })
        .catch((m) => {
          u({ type: "dataFailed" });
        });
      ...
      children: [
        ...
        P.jsxs(Md, {
          children: [
            n === "loading" && P.jsx(Dd, {}),
            n === "error" && P.jsx(tc, {}),
            n === "ready" && P.jsx(Fd, { numQuestions: s, handleClick: u }),
            n === "active" &&
              P.jsxs(P.Fragment, {
                children: [
                  P.jsx(Ad, {
                  ...
                  P.jsx(Ud, { question: e[t], dispatch: u, answer: r }),
                  P.jsxs(Bd, {
                    children: [
                      P.jsx(Qd, { dispatch: u, secondsRemaining: i }),
                      P.jsx($d, {
                        dispatch: u,
                        answer: r,
                        index: t,
...
Wl.createRoot(document.getElementById("root")).render(
  P.jsx(Sc.StrictMode, { children: P.jsx(Yd, {}) })
);
